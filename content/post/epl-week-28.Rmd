...
Harry Kane turned up with a late winner for Spurs again this week. In 5 of his past 9 scoring appearances he has been there sole  
...
hth %>% 
  filter(season=="2017/18"&gameDate>="2018-02-14" &gameDate<="2018-03-03") %>% ## may need to put in day later?
  filter(venue=="H") %>% 
...
# table
hth %>% 
  filter(season=="2017/18"&gameDate<="2018-03-03") %>% 
  group_by(team) %>% 
